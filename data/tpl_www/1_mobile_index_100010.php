...
.main-100010 .box .alert-bg{width: 95%; height: 35px; margin: 0 0 0 8px; 
	background:url('tpl/www_mobile/images/n1_tuijian.jpg') no-repeat center left;
	...
	<div class="right">
		...
		<div class="content">
			...
			<div class="box">
				...
				<div class="title"><a href="/<?php echo $value['id'];?>.html"><?php echo phpok_cut($value['title'],'15','…');?> <span><?php echo date('Y/m',$value['dateline']);?></span></a> </div>
				<?php } ?>
			</div>
