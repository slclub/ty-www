...
.banner-bg{
	width:100%;
	height:118px;
	/*background:url('../tpl/www_mobile/images/bg_title.png') right center;*/
	background:url('../tpl/www_mobile/images/n1_top.png') repeat-x;
	text-align:center;
	margin: 0 auto;
	overflow:hidden;
	z-index: 1;
...
.banner ul li:hover{
	...
	background:url('tpl/www_mobile/images/n1_top_li_bg.png') bottom no-repeat;
	color:white;
}
.banner .hover{
	/*background: url('res/201710/04/11db87d11bef4bf2.png') bottom no-repeat*/;
...
<div class="banner">
	<div style="width:100%;margin:0 auto;" id="banner-zhuti">
		<div style="float: left; width:25%;position: relative; height: 100px;">
			<div style="position: absolute;z-index: 110; height: 160px;">
				<img src="/tpl/www_mobile/images/n1_mingyun.png" width="256">
			</div>
