...
<div class="main" id="main" style="">
	...
	<div class="banner-bac">
		<div class="bd">
			<ul>
				...
				<li><a href="<?php echo $value['link'];?>" target="<?php echo $value['target'];?>" title="<?php echo $value['title'];?>"><img src="/tpl/www/images/n1_bg.jpg" _src="<?php echo $value['pic']['filename'];?>" alt="<?php echo $value['title'];?>"/></a></li>
	...
	<div style="position:absolute;width:100%;text-align:center;height:100%;left:0;top:0;z-index:1;">
		...
		<!--main-body begin-->
		<div class="main-box"> 
			<!--<div style="margin-top:440px;float:right"><img src="tpl/www/images/Icon.png" width="300"></div>-->
			<div class="zhuti" >
				<div style="width:1200px;height:100%;position:relative;margin:0 auto;">
					...
					<div class="right">
						...
						<!--
						<div class="icon-andriod"><img src="tpl/www/images/n1_android.jpg" alt="andriod"></div>
						<div class="icon-ios"><img src="tpl/www/images/n1_apple.jpg" alt="ios"></div>
						-->
						<div class="icon-contact"><img src="tpl/www/images/n1_tel.jpg" alt="contact" style="opacity: 1"></div>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="tpl/www/js/chinaz.js" ></script>
