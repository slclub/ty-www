<?php if(!defined("PHPOK_SET")){exit("<h1>Access Denied</h1>");} ?><?php $cssfile = $css ? "tpl/www_mobile/css/style.css,artdialog.css,".$css : "tpl/www_mobile/css/style.css,artdialog.css";?>
