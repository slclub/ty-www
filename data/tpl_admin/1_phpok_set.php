...
<div class="table">
	...
	<div class="content">
		<ul class="layout">
			<?php $tmpid["num"] = 0;$phpok_type_list=is_array($phpok_type_list) ? $phpok_type_list : array();$tmpid["total"] = count($phpok_type_list);$tmpid["index"] = -1;foreach($phpok_type_list AS $key=>$value){ $tmpid["num"]++;$tmpid["index"]++; ?>
...
<div class="table hide" name="ext_attr" ext="param">
	...
	<div class="content">
		<ul class="layout">
			...
			<?php $tmpid["num"] = 0;$attrlist=is_array($attrlist) ? $attrlist : array();$tmpid["total"] = count($attrlist);$tmpid["index"] = -1;foreach($attrlist AS $key=>$value){ $tmpid["num"]++;$tmpid["index"]++; ?>
...
<div class="table hide" ext="param" name="ext_usergroup">
	...
	<div class="content">
		<select name="usergroup" id="usergroup">
			<option value="">请选择…</option>
			<?php $tmpid["num"] = 0;$usergroup=is_array($usergroup) ? $usergroup : array();$tmpid["total"] = count($usergroup);$tmpid["index"] = -1;foreach($usergroup AS $key=>$value){ $tmpid["num"]++;$tmpid["index"]++; ?>
