...
<body>
<div class="header">
	<div class="logo"><a href="<?php echo $sys['admin_file'];?>" title="<?php echo $config['title'];?>"><img src="<?php echo $config['adm_logo29'] ? $config['adm_logo29'] : 'images/logo.jpg';?>" alt="<?php echo $config['title'];?>" height="45px" width="219px" /></a></div>
