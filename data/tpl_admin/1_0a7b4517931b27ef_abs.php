...
<tr>
	<td><input type="text" id="title_<?php echo $_rs['identifier'];?>" name="title_<?php echo $_rs['identifier'];?>" style="width:150px;" disabled /></td>
	<td>&nbsp;</td>
	<td><input type="button" value="会员" class="btn" id="_phpok_button_user_<?php echo $_rs['identifier'];?>" /></td>
	<td>&nbsp;</td>
	<td><input type="button" value="删除" class="btn" onclick="$('#<?php echo $_rs['identifier'];?>').val('');$('#title_<?php echo $_rs['identifier'];?>').val('')" /></td>
</tr>
</table>
<?php } ?>