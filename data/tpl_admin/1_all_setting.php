...
<div class="table">
	...
	<div class="content">
		<table>
		<tr>
			<td><label><input type="radio" name="register_status" value="1" <?php if($rs['register_status']){ ?> checked<?php } ?> /> <?php echo P_Lang("开启");?></label></td>
			<td><label><input type="radio" name="register_status" value="0" <?php if(!$rs['register_status']){ ?> checked<?php } ?> /> <?php echo P_Lang("关闭");?></label></td>
			<td class="gray"><?php echo P_Lang("原因：");?></td>
			<td><input type="text" id="register_close" name="register_close" class="long" value="<?php echo $rs['register_close'];?>" /></td>
		</tr>
		</table>
	</div>
</div>
<div class="table">
	...
	<div class="content">
		<table>
		<tr>
			<td><label><input type="radio" name="login_status" value="1" <?php if($rs['login_status']){ ?> checked<?php } ?> /> <?php echo P_Lang("开启");?></label></td>
			<td><label><input type="radio" name="login_status" value="0" <?php if(!$rs['login_status']){ ?> checked<?php } ?> /> <?php echo P_Lang("关闭");?></label></td>
			<td class="gray"><?php echo P_Lang("原因：");?></td>
			<td><input type="text" id="login_close" name="login_close" class="long" value="<?php echo $rs['login_close'];?>" /></td>
		</tr>
		</table>
	</div>
</div>
