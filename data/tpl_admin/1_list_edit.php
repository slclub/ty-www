	...
	<div class="biz_attr">
		<div class="biz_attr_select">
			...
			<tr>
				...
				<td>&nbsp;</td>
				<?php } ?>
				<td><input type="button" value="<?php echo P_Lang("添加属性");?>" onclick="attr_add('<?php echo $id;?>','<?php echo $p_rs['id'];?>')" class="phpok-btn" /></td>
...
<div class="main2">
	...
	<div class="pfw mb10">
		...
		<tr>
			<td align="right"><?php echo P_Lang("重量：");?></td>
			<td><input type="text" id="weight" name="weight" class="short" value="<?php echo $rs['weight'];?>" /> 千克</td>
		</tr>
		<?php } ?>
		<?php if($freight && $freight['type'] == 'volume'){ ?>
		<tr>
			<td align="right"><?php echo P_Lang("体积：");?></td>
			<td><input type="text" id="volume" name="volume" class="short" value="<?php echo $rs['volume'];?>" /> 立方米</td>
		</tr>
		<?php } ?>
		<tr>
			<td align="right"><?php echo P_Lang("计量单位：");?></td>
			<td><input type="text" id="unit" name="unit" class="short" value="<?php echo $rs['unit'];?>" /></td>
		</tr>
		<tr>
			<td>
			...
			<td><input type="text" id="price" name="price" value="<?php echo $rs['price'];?>" style="width:98%" /></td>
		</tr>
		</table></div>
	</div>
	<?php } ?>
	...
	<div class="pfw mb10">
		<h3><?php echo P_Lang("绑定会员");?></h3>
		<table>
		<tr>
			<td><?php echo form_edit('user_id',$rs['user_id'],'user');?></td>
		</tr>
		</table>
	</div>
	<?php } ?>
