...
<div id="module_set" class="hidden">
	...
	<div id="use_biz_setting"<?php if(!$rs['is_biz']){ ?> style="display:none"<?php } ?>>
	<div class="table">
		<div class="title">
	...
	<div class="table">
		...
		<div class="content">
			<select name="freight">
				...
				<?php $tmpid["num"] = 0;$freight=is_array($freight) ? $freight : array();$tmpid["total"] = count($freight);$tmpid["index"] = -1;foreach($freight AS $key=>$value){ $tmpid["num"]++;$tmpid["index"]++; ?>
